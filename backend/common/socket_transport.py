...
def create_dual_server_config(service_name: str, port: int) -> Dict[str, Any]:
    """
    Create uvicorn server config that listens on both HTTP and socket
    ...
    Returns:
        Config dict for running both HTTP and socket servers
    """
